...
var DBService = /** @class */ (function () {
    function DBService(_name, Adapter) {
        if (Adapter === void 0) { Adapter = LocalStorage; }
        this._name = _name;
        this.ready = this.initialize(Adapter);
    }
    DBService.prototype.initialize = function (Adapter) {
        return __awaiter(this, void 0, void 0, function () {
            var name, adapter, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = this;
                        if (!!("then" in adapter)) return [3 /*break*/, 1];
                        _b = low(adapter);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, low(adapter)];
                    case 2:
                        _b = _c.sent();
                        _c.label = 3;
                    case 3:
